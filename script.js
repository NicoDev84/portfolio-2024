...
const translations = {
    fr: {
        ...
        homeDesc: "Jeune développeur front-end, récemment formé, je suis passionné par le développement web et la création d'interfaces élégantes et réactives. Bien que débutant, j'ai acquis de solides bases en HTML, CSS, JavaScript, et je suis constamment en train d'apprendre de nouvelles technologies pour améliorer mes compétences. Curieux et déterminé, je suis prêt à contribuer à des projets dynamiques et innovants.",
        viewMore: "Voir plus",
